function botcode(bot, game, mail) {
  ...
  const nearbyPlayers = () => {
    ...
    for (const key in nearplayers) {
      ...
      const playerList = ['LalaLexie.', 'NekaShandra.', 'NekaShandra', 'ImNotJewelrich_.', 'DR4C0N14N.', 'DR4C0N14N', 'TBG89.', 'Fus1', '_Lezly', 'LalaLexie.', 'Lynch12345.', 'OnlyRedOpps21.', 'abedqwer.', 'FlanNolan.', 'itdimk.', 'dANiael471.', 'MoosaImran.', 'Eren_Yaeger_.', 'SidraPlayz.', 'DrBaconXD.', 'Illvinia.', 'Aslari.', 'N41N0C4RD.', 'MabaMaba.', 'FransoyGlo', 'Undisputed_.', 'Omegadudy2.', 'Echo_1o1.', 'Mine_Craftier.', 'IHAVEBEENBETTER.', 'XPFORLIFE0TR9l.', 'Tr0ll.', 'Suhaibbhaiop.', 'lowkeyy_kevin.', 'EgirlNicole.', 'NvGTX.', 'NvRTX.', 'Zenalynn.', 'sph2012.', 'Thweef', '_NOOBMaster69_', 'Leloush.', 'MrRius99.', 'frazxedYT.', 'ParimalYT.', 'Bobybhatt.', 'Qutie_', 'Diger1953.', 'VanishX.', 'CrazyCrafterZ.', 'VegitoX_.', 'Suvrajit.', 'Mine_Craftier.', 'McCutieGirl.', 'Rozsa_', 'Paukstyte.', 'Nekoooo_.', 'xVqnish', 'potetoman.', 'ludak123.', 'ludak123', '_watery', 'Hybrid_Gamer.', 'Hybrid_Gamer', 'Xzykou.', 'MrRius99', 'Ruse.', 'N1C0L4SPRO.', 'BatozarGaming.', 'J05EPHN00B.', 'AKU_SUKA_NICO.', 'GIRRAJ.', 'KavinOP123.', 'M4ef.', 'Squidneon', 'FaKeCsGg22.', 'faizkhanop121.', 'RD_PLAYSYT.', 'the_deadly_noob.', 'AWM_Akshaj.', 'galson2008.', 'RD_PLAYSYT', 'KushagrRajput.', 'RDPLAYSYT.', 'ZaIdOlA.', 'MLG_ZackXD.', 'Shadow__Boy11', 'xfraz.', 'ryan20230.', 'ham_miner.', 'uyaywuha.', 'ham_ces.']
  ...
  const commands = (msg) => {
    ...
    else if (msg.includes('toggle sell')) sellRodsEnabled = !sellRodsEnabled
